...
---
вДве методики контроля отрицательных остатков при проведении документа: **Старая** (проверка до записи) и **Новая** (проверка после записи с откатом). Выбор зависит от архитектуры и требований к параллельности.
